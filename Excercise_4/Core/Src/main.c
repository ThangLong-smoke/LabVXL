...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, LED_7_SEG_a_Pin|LED_7_SEG_b_Pin|LED_7_SEG_c_Pin|LED_7_SEG_d_Pin
                          |LED_7_SEG_e_Pin|LED_7_SEG_f_Pin|LED_7_SEG_g_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_7_SEG_a_Pin LED_7_SEG_b_Pin LED_7_SEG_c_Pin LED_7_SEG_d_Pin
                           LED_7_SEG_e_Pin LED_7_SEG_f_Pin LED_7_SEG_g_Pin */
  GPIO_InitStruct.Pin = LED_7_SEG_a_Pin|LED_7_SEG_b_Pin|LED_7_SEG_c_Pin|LED_7_SEG_d_Pin
                          |LED_7_SEG_e_Pin|LED_7_SEG_f_Pin|LED_7_SEG_g_Pin;
